;Unit_Bomber
	setUnitDefaults		Unit_Bomber
	
	setUnitName		Unit_Bomber,2246
	...
	setUnitClass		Unit_Bomber,ClassPlane
	setUnitMoveType		Unit_Bomber,MoveAir
	setUnitBuildLocation	Unit_Bomber,BuildAirport
	setUnitSupplyTerrain	Unit_Bomber,SuppliedByAirport
	setUnitFuelBurn		Unit_Bomber,FuelUseageTypePlane
	
	setUnitAIType			Unit_Bomber,AIDirectCombat
