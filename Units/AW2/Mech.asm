;Unit_Mech
	...
	setUnitDamagePrimary	Unit_Mech,75,Unit_Missiles
	...
	setUnitDamageSecondary	Unit_Mech,15,Unit_Recon
	setUnitDamageSecondary	Unit_Mech,25,Unit_APC
	setUnitDamageSecondary	Unit_Mech,05,Unit_AntiAir
