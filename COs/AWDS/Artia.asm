	...
	setCOPowerMusic         coAWDSArtia,MusicBlackPower
	setCOSuperMusic         coAWDSArtia,MusicBlackSuper
	...
	setCOPowerAllStat	coAWDSArtia,0,0,1,0
	setCOSuperAllStat	coAWDSArtia,0,0,2,0
